...
--changeset ggordham:upd_emp_contact_proc_v1.1 endDelimiter:/ rollbackEndDelimiter:/
--comment updated to include instagram contact type v1.1 of procedure
...
BEGIN
  CASE p_contact_code
    ...
    WHEN 'I' THEN v_contact_type := 'INSTAGRAM';
    ELSE raise_application_error( -20000, 'Invalid conctact code provided!');
  END CASE;
