...
var str2 VARCHAR2(2000)
exec :str2 := dbms_random.string('u',50);

-- Note this create 250,000 rows 
--  original created 2,500,000 rows (second select was 500 not 50)
--  ran out of space on 23ai free (12GB)
...
from (
    ...
    from (select null from dual connect by level <= 5000)
       , (select null from dual connect by level <= 50)
     );
