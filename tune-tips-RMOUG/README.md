# tune-tips-RMOUG
Scripts from Rocky Mountain Oracle Users Group Training Days, Feb 12, 2025
...
```sql
@@spm_one_shot.sql 3tbpavnz7rnc4
...
```bash
curl -L https://github.com/ggordham/ora-presentations/tarball/main | tar xz --strip=1 "ggordham-ora-presentations-???????/tune-tips-RMOUG"
```
