...
```bash
podman exec -it dbt sh -c "chmod +x splus.sh; /home/oracle/splus.sh sql23d"
...
podman cp dbt:/home/oracle/23ai-sql-perf-DBT/monitor_output.html .
...
```sh
curl -L https://github.com/ggordham/ora-presentations/tarball/main | tar xz --strip=1 "ggordham-ora-presentations-???????/23ai-sql-perf-DBT"
...
sqlplus /nolog <<'EOF'
@mksample.sql Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 Oradb$_Lab42 users temp /home/oracle/23ai-sql-perf-DBT/samp/ freepdb1
