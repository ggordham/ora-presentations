...
GRANT SELECT,UPDATE,INSERT,DELETE ON sh.channels TO perflab;
GRANT SELECT,UPDATE,INSERT,DELETE ON sh.countries TO perflab;
GRANT SELECT ON sh.sales_transactions_ext TO perflab;
