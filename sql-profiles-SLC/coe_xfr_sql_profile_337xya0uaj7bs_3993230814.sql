SPO coe_xfr_sql_profile_337xya0uaj7bs_3993230814.log;
SET ECHO ON TERM ON LIN 2000 TRIMS ON NUMF 99999999999999999999;
REM
REM $Header: 215187.1 coe_xfr_sql_profile_337xya0uaj7bs_3993230814.sql 11.4.1.4 2023/03/06 csierra $
REM
...
REM
REM SCRIPT
REM   coe_xfr_sql_profile_337xya0uaj7bs_3993230814.sql
REM
REM DESCRIPTION
REM   This script is generated by coe_xfr_sql_profile.sql
REM   It contains the SQL*Plus commands to create a custom
REM   SQL Profile for SQL_ID 337xya0uaj7bs based on plan hash
...
REM
REM EXAMPLE
REM   SQL> START coe_xfr_sql_profile_337xya0uaj7bs_3993230814.sql;
REM
REM NOTES
...
REM      EXEC DBMS_SQLTUNE.DROP_SQL_PROFILE('coe_337xya0uaj7bs_3993230814');
...
sql_text    => sql_txt,
profile     => h,
name        => 'coe_337xya0uaj7bs_3993230814',
description => 'coe 337xya0uaj7bs 3993230814 '||:signature||'',
category    => 'DEFAULT',
validate    => TRUE,
replace     => TRUE,
...
SPO OFF;
PRO
PRO COE_XFR_SQL_PROFILE_337xya0uaj7bs_3993230814 completed
