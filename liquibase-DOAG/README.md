...
DOAG 2025 Conference + Exhibition - November 18th, 2025
...
```bash
curl -L https://github.com/ggordham/ora-presentations/tarball/main | tar xz --strip=1 "ggordham-ora-presentations-???????/liquibase-DOAG"
...
```bash
git diff --name-only | grep liquibase-DOAG
