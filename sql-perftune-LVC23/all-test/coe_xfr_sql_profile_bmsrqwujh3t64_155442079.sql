SPO coe_xfr_sql_profile_bmsrqwujh3t64_155442079.log;
SET ECHO ON TERM ON LIN 2000 TRIMS ON NUMF 99999999999999999999;
REM
REM $Header: 215187.1 coe_xfr_sql_profile_bmsrqwujh3t64_155442079.sql 11.4.1.4 2023/03/01 csierra $
REM
...
REM
REM EXAMPLE
REM   SQL> START coe_xfr_sql_profile_bmsrqwujh3t64_155442079.sql;
REM
REM NOTES
...
REM      EXEC DBMS_SQLTUNE.DROP_SQL_PROFILE('coe_bmsrqwujh3t64_155442079');
...
q'[INDEX(@"SEL$1" "S"@"SEL$1" ("SALES"."SALE_DATE"))]',
q'[END_OUTLINE_DATA]');
:signature := DBMS_SQLTUNE.SQLTEXT_TO_SIGNATURE(sql_txt);
DBMS_SQLTUNE.IMPORT_SQL_PROFILE (
sql_text    => sql_txt,
profile     => h,
name        => 'coe_bmsrqwujh3t64_155442079',
description => 'coe bmsrqwujh3t64 155442079 '||:signature||'',
category    => 'DEFAULT',
validate    => TRUE,
replace     => TRUE,
...
SPO OFF;
PRO
PRO COE_XFR_SQL_PROFILE_bmsrqwujh3t64_155442079 completed
