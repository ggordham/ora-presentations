...
Scripts for Oracle Adaptive SQL Optimization - Why do things go so bad? MOUG / COUG presentation
...
_Note COUG in the command is the container name, use your container name. You can find your container name with the podman ps command._
...
```bash
podman exec -it COUG sh -c "chmod +x splus.sh; /home/oracle/splus.sh adsc"
```
