...
--
-- Note increased rows from 500K to 600K to deal with issues running
--  in docker where the data was not skewed enough.
--  Index scan vs table full scan costs were within 10 of each other
